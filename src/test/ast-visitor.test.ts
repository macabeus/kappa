...
import {
  ASTVisitor,
  ASTVisitorPlugin,
  BaseASTVisitorPlugin,
} from "../ast-visitor";

/**
 * Example plugin that counts different types of statements
 */
export class StatementCounterPlugin extends BaseASTVisitorPlugin {
...
suite("AST Visitor Test Suite", () => {
  ...
  suite("BaseASTVisitorPlugin", () => {
    class TestBasePlugin extends BaseASTVisitorPlugin {
  ...
  suite("ASTVisitor getNodeType Method", () => {
    ...
    test("should extract complex type from arcana field", () => {
      ...
      node.arcana =
        "VarDecl <0x789> <col:1, col:20> 'std::vector<int>' varName";
    ...
    test("should extract function type from arcana field", () => {
      ...
      node.arcana =
        "FunctionDecl <0xdef> <col:1, col:30> 'void (int, char *)' main";
    ...
    test("should extract type with special characters", () => {
      ...
      node.arcana =
        "TypedefDecl <0x456> <col:1, col:25> 'std::map<std::string, int>' MyMap";
